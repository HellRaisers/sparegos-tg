...
**приглашениях на проекты** на Upwork.

Для сообщения в чат приходит: **кто написал**, **по какому проекту**, **сам
текст сообщения** и **кнопка «Открыть переписку»**.
Для приглашения (`Invitation to Apply`): **название вакансии**, **условия**,
**описание** и **кнопка «Открыть приглашение»**.

> Есть два вида писем Upwork о сообщениях клиента, бот ловит оба:
